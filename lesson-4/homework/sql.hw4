...
6.SELECT ISNULL(Email, 'noemail@example.com') AS Email, *
FROM Employees;
...
12.SELECT EmployeeID, COALESCE(FirstName, LastName) AS Name
FROM Employees;
...
21.SELECT EmployeeID, (FirstName + ' ' + LastName) AS FullName
FROM Employees;
